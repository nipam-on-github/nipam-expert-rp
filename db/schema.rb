...
ActiveRecord::Schema.define(version: 2021_04_19_102118) do
  ...
  create_table "register_purposes", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  create_table "register_temps", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
