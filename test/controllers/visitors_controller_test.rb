...
class VisitorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create visitor" do
    assert_difference('Visitor.count') do
      post visitors_url, params: { visitor: { contact_number: @visitor.contact_number, loc_org: @visitor.loc_org, name: @visitor.name } }
    end
  ...
  test "should update visitor" do
    patch visitor_url(@visitor), params: { visitor: { contact_number: @visitor.contact_number, loc_org: @visitor.loc_org, name: @visitor.name } }
